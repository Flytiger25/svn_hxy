...
IMPLEMENT_DYNAMIC(Action_NsidedHoleFilling, CPropertyPage)
Action_NsidedHoleFilling::Action_NsidedHoleFilling()
{
...
void Action_NsidedHoleFilling::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(Action_NsidedHoleFilling, CPropertyPage)
	ON_BN_CLICKED(IDC_BUTTON_ACIS_CHECK_ENTITY, &Action_NsidedHoleFilling::OnBnClickedCheckEntity)
	ON_NOTIFY(NM_THEMECHANGED, IDC_SCROLLBAR2, &Action_NsidedHoleFilling::OnNMThemeChangedScrollbar2)
	ON_BN_CLICKED(IDC_BUTTON_NSIDEDHOLEFILLING, &Action_NsidedHoleFilling::OnBnClickedButtonNsidedholefilling)
END_MESSAGE_MAP()

extern CSDIViewSwitchDoc* pDoc;
void Action_NsidedHoleFilling::OnBnClickedCheckEntity()
{
...
void Action_NsidedHoleFilling::OnNMThemeChangedScrollbar2(NMHDR* pNMHDR, LRESULT* pResult)
{
...
BOOL Action_NsidedHoleFilling::OnInitDialog()
{
...
void Action_NsidedHoleFilling::OnBnClickedButtonNsidedholefilling()
{
	// TODO: 在此添加控件通知处理程序代码
