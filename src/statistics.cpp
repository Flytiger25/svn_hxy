...
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_covm;
    _task->data.parameters[0].value.val = x;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.ival = m;
    _task->data.parameters[3].value.val = c;
    ae_push_root_task(_task);
    ae_wait_for_event(&_task->done_event);
    c = (ae_matrix*)_task->data.parameters[3].value.val;
...
/*************************************************************************
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_covm(ae_task_data *_data, ae_state *_state)
{
    ...
    ae_int_t m;
    ae_matrix* c;
    x = (ae_matrix*)_data->parameters[0].value.val;
    n = _data->parameters[1].value.ival;
    m = _data->parameters[2].value.ival;
    c = (ae_matrix*)_data->parameters[3].value.val;
    covm(x,n,m,c, _state);
    _data->parameters[3].value.val = c;
}
    ...
    /* Real    */ ae_matrix* c, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_pearsoncorrm;
    _task->data.parameters[0].value.val = x;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.ival = m;
    _task->data.parameters[3].value.val = c;
    ...
    /* Real    */ ae_matrix* c, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_spearmancorrm;
    _task->data.parameters[0].value.val = x;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.ival = m;
    _task->data.parameters[3].value.val = c;
    ...
    /* Real    */ ae_matrix* c, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_covm2;
    _task->data.parameters[0].value.val = x;
    _task->data.parameters[1].value.val = y;
    _task->data.parameters[2].value.ival = n;
    _task->data.parameters[3].value.ival = m1;
    _task->data.parameters[4].value.ival = m2;
    _task->data.parameters[5].value.val = c;
    ae_push_root_task(_task);
    ae_wait_for_event(&_task->done_event);
    c = (ae_matrix*)_task->data.parameters[5].value.val;
    _e = (char*)_task->exception;
    ae_dispose_task(_task);
    ae_assert(_e==NULL, _e, _state);
}
...
void _root_covm2(ae_task_data *_data, ae_state *_state)
{
    ...
    ae_matrix* c;
    x = (ae_matrix*)_data->parameters[0].value.val;
    y = (ae_matrix*)_data->parameters[1].value.val;
    n = _data->parameters[2].value.ival;
    m1 = _data->parameters[3].value.ival;
    m2 = _data->parameters[4].value.ival;
    c = (ae_matrix*)_data->parameters[5].value.val;
    covm2(x,y,n,m1,m2,c, _state);
    _data->parameters[5].value.val = c;
}
    ...
    /* Real    */ ae_matrix* c, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_pearsoncorrm2;
    _task->data.parameters[0].value.val = x;
    _task->data.parameters[1].value.val = y;
    _task->data.parameters[2].value.ival = n;
    _task->data.parameters[3].value.ival = m1;
     ...
     ae_state *_state)
{
    ...
    _spawn_rankdata(&xc, m1, n, _child_tasks, _smp_enabled, _state);
    ...
    /* Real    */ ae_matrix* c, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_spearmancorrm2;
    _task->data.parameters[0].value.val = x;
    _task->data.parameters[1].value.val = y;
    _task->data.parameters[2].value.ival = n;
    _task->data.parameters[3].value.ival = m1;
    ...
    ae_int_t nfeatures, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_rankdata;
    ...
    ae_int_t nfeatures, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_rankdatacentered;
    _task->data.parameters[0].value.val = xy;
    _task->data.parameters[1].value.ival = npoints;
    _task->data.parameters[2].value.ival = nfeatures;
    ae_push_root_task(_task);
